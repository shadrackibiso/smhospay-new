        ...
        <form className="payForm" onSubmit={(e) => e.preventDefault()}>
            <div className="row">
                ...
                <div className="col-lg-6 d-flex flex-column">
                    ...
                    <select className="inputContainer" onChange={(e) => setPaymentType(e.target.value)}>
                ...
                <div className="col-lg-6 d-flex flex-column mt-3 mt-md-0">
                    <label>Amount</label>
                    <input type="number" name="amount" className="inputContainer" onChange={(e) => setAmount(e.target.value * 100)} required />
                </div>
                {/* NOTE */}
                ...
                <div className="col mt-5 d-flex align-items-center justify-content-center">
                    <PaystackButton className="mainBtn px-5 py-2 shadow" {...componentProps} />
                </div>
            </div>
        </form>
        </>
